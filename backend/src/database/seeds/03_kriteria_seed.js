...
exports.seed = async function(knex) {
  await knex('kriteria').insert([
    ...
    { id_kriteria: 2, nama_kriteria: 'Fasilitas', bobot_prioritas: 0.25, jenis: 'benefit' },
    ...
    { id_kriteria: 5, nama_kriteria: 'Waktu Kunjungan', bobot_prioritas: 0.10, jenis: 'benefit' } // Kriteria Baru
  ]);
};