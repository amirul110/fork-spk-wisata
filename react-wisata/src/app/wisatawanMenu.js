export const wisatawanMenu = [
  ...
  { label: "Pilih Kriteria", icon: "pi pi-check-square", path: "/wisatawan/pilih-kriteria" },
{ label: "Aktifkan Lokasi", icon: "pi pi-map-marker", path: "/wisatawan/pilih-lokasi" },
  { label: "Pilih Preferensi", icon: "pi pi-check-square", path: "/wisatawan/pilih-preferensi" },
